...
// ConvertAccessType converts the access type string between
// what the API uses and the CLI.
// It converts "console_access" to "web", and vice versa, and
// "short_term_key_access" to "cli" and vice versa.
