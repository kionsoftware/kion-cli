...
func redirectServer(url string, typeID uint) {
    ...
    <html lang="en">
      ...
      <body>
        <svg id="kion_logo_mark" viewBox="0 0 500.00001 499.99998" version="1.1" width="200" height="200" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
